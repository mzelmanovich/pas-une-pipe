...
var _Emitter2 = __webpack_require__(1);
...
var _ElWatcher = __webpack_require__(0);

var _ElWatcher2 = _interopRequireDefault(_ElWatcher);

var _ElVisible = __webpack_require__(3);

var _ElVisible2 = _interopRequireDefault(_ElVisible);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var nodeWatcher = new _ElWatcher2.default();
var visWatcher = new _ElVisible2.default(0.01);

visWatcher.on('changeDetected', function (change) {
  return console.log(change);
});
nodeWatcher.on('elAdded', function (el) {
  return visWatcher.watch(el);
});
nodeWatcher.start();
